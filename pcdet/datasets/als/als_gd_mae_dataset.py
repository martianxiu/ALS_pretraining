...
class ALSGDMAEDataset(DatasetTemplateALSBEVMAE):
    ...
    def collate_batch(batch_list, _unused=False):
        ...
        for key, val in data_dict.items():
            try:
                if key in ['voxels', 'voxel_num_points', 'voxel_sampled_indices_data_process', 'random_sampled_indices_data_process']:
