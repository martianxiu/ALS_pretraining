...
from .processor.data_processor_bevmae import  DataProcessor as DataProcessorBEVMAE
...
class DatasetTemplate(torch_data.Dataset):
    def __init__(self, dataset_cfg=None, class_names=None, training=True, root_path=None, logger=None):
        super().__init__()
        self.dataset_cfg = dataset_cfg # DATA_CONFIG in cfg
        ...
        self.data_augmentor = DataAugmentor( # perform online augmentation to sample or gt.
            self.root_path, self.dataset_cfg.DATA_AUGMENTOR, self.class_names, logger=self.logger
        ) if self.training else None

        self.data_processor = DataProcessor( # perform data processing before feeding data to models 
