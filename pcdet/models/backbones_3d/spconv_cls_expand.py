...
class VoxelResBackBone8x_expand(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, voxel_size, point_cloud_range, **kwargs):
        super().__init__()
        self.model_cfg = model_cfg
        self.sparse_shape = grid_size[::-1] + [1, 0, 0]
        ...
        self.num_point_features = self.out_last
    ...
    def forward(self, batch_dict):
        ...
        batch_dict['point_features'] = out.features
        batch_dict['point_indices'] = out.indices
        # point_coords = common_utils.get_voxel_centers(
        #     x_up1.indices[:, 1:], downsample_times=1, voxel_size=self.voxel_size,
        #     point_cloud_range=self.point_cloud_range
        # )
