...
class BEV_MAE_Cls(Classifier3DTemplateBEVMAE):
    ...
    def get_training_loss(self):
        ...
        loss_seg, tb_dict = self.cls_head.get_loss() # loss_rpn: total loss, tb_dict: separate loss for TB logging
        tb_dict = {
            'loss_cls': loss_seg.item(),
            **tb_dict
        }
